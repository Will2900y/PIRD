...
smodel1 = ARIMA(train, order=(0, 0, 1), seasonal_order = (0, 1, 1, 7))  # chose the order from AUTO # chose the order from AUTO
smodel2 = ARIMA(s, order=(0, 0, 1), seasonal_order = (0, 1, 1, 7))  # chose the order from AUTO # chose the order from AUTO
