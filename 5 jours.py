...
s = s34 # chose the app of analysis and if if DHW or Power
...
model_auto1 = ARIMA(train, order=(0, 1, 0)) # chose the order from AUTO # chose the order from AUTO
model_auto2 = ARIMA(s, order=(0, 1, 0))  # chose the order from AUTO # chose the order from AUTO
...
smodel1 = ARIMA(train, order=(0, 1, 0), seasonal_order = (1, 1, 0, 24))  # chose the order from AUTO # chose the order from AUTO
smodel2 = ARIMA(s, order=(0, 1, 0), seasonal_order = (1, 1, 0, 24))  # chose the order from AUTO # chose the order from AUTO
